...
// Desplazamientos
const desplazamientoVertical = new DesplazarAutomaticamenteVertical(posicionFija = game.at(1, 15), dimensionDePantalla = dimensionPantallaJuego)
...
const escenarioVideojuego = new Escenario(fondo = pantallaEscenario, personajes = personajesVideojuego, tiempoPartida = tiempo, 
    numerosEnPartida = new GenerarNumerosVisibles()
)
